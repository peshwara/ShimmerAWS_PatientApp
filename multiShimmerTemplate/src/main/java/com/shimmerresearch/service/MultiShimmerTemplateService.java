...
public class MultiShimmerTemplateService extends Service {
   ...
   private static WeakReference<MultiShimmerTemplateService> mService;
	...
	public static void setDdb(AmazonDynamoDBClient ddb) {
		MultiShimmerTemplateService.ddb = ddb;
	}
	...
	Logging.DBUpload dbUpload = new Logging.DBUpload();
...
//							}
	            	   ...
	            	   if (mWriting==true){
		            	   ...
		            	   if (shimmerLog1!=null){
							   shimmerLog1.logData(objectCluster, getDb(), idx);
		            		   idx++;
		            	   } else{
