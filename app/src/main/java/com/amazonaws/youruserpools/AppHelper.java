...
public class AppHelper {
    ...
    public static final String IDENTITY_POOL_ID = "us-east-1:08e9dc80-fcb3-4450-b1a9-ee1f960beba1";
    public static final String TEST_TABLE_NAME = "MyTableName";
     ...
     */
    private static final String userPoolId = "us-east-1_s5gi9I1BT";

    /**
     * Add you app id
     */
    private static final String clientId = "7cunobqd3lh0inkat7nrahvnsf";
     ...
     */
    private static final String clientSecret = "6hcmsgvjmamagpat1niso47ejj9ugr6mk88ksmpvqe2q18lqkug";
    ...
    private static void setData() {
        ...
        attributeDisplaySeq.add("PreExisting_Conditions");
        attributeDisplaySeq.add("Current_Medications");
        attributeDisplaySeq.add("Associated_Doctor");
        attributeDisplaySeq.add("Patient_ID");
