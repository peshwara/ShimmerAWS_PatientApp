...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        main_title.setText("Patient's Profile");
    ...
    private void sendECG(){
        Intent sendECGActivity = new Intent(this,ECG.class);
        startActivityForResult(sendECGActivity, 20);
    }
